...
| [058](CARD-058-botao-traduzir-no-app.md) | **O botão `traduzir` ganha tela** — o adendo que o CARD-016 prometeu quando o CARD-036 existisse | 3 | mobile | P | 016, 036 | backlog — criado em 2026-09-13, a pedido do desenvolvedor depois de usar o app no aparelho físico |
