...
| [059](CARD-059-tela-de-configuracoes.md) | **Configurações: quarta aba**, para preferência de aparelho (não de conta) | 3 | mobile | P | 029; item de reprodução depende do 035 | backlog — criado em 2026-09-13; sem artboard de referência, escopo decidido em conversa com o desenvolvedor (3 seções: reprodução, limite de gravação como leitura, sobre) |
