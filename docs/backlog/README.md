...
| [050](CARD-050-a-sessao-autenticada-no-cliente.md) | **A sessão autenticada no cliente** — secure storage, refresh e expiração | 3 | mobile | M | 049 (concluído), ADR-0007 | backlog — **bloqueante de V1.0 (N3), agora urgente**: o CARD-049 ativou auth real em todas as rotas (decisão do desenvolvedor); o app mobile não fala com o backend até este card existir. O refresh concorrente é o bug que derruba a família de tokens |
